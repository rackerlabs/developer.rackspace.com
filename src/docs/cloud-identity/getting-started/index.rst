...
account API key. Your API key is retrievable from the "Account Settings" page
...
role), it will return *all* users for the tenant. To refine this collection,
...
There are two *types* of role for the Rackspace Cloud Identity service: global
roles and product roles. Global roles define access and permissions across *all*
